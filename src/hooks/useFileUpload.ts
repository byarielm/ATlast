...
export function useFileUpload(
  onSearchStart: (results: SearchResult[]) => void,
  ...
  async function handleFileUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const errorMsg = error instanceof FileParseError 
        ? error.message
        : "There was a problem processing the file. Please check that it's a valid TikTok data export.";
